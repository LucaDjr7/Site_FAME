...
/**
 * Réduit la taille de police de son contenu jusqu'à ce qu'il tienne (hauteur ET
 * largeur) dans la boîte dimensionnée par le parent — pas de troncature.
 * Les enfants doivent exprimer leurs tailles en `em` pour scaler ensemble
 * (la boîte porte la taille de base). Re-fit sur redimensionnement (ResizeObserver).
 */
