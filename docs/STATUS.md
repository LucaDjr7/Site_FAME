...
> - **115 tests verts, `tsc`/`lint` à 0, build OK, `@config` intact.** ⚠️ Une régression de la fix-wave CONV-01 (trick currentColor changeant le texte actif MemberGrid #b88c30→#e8b149) a été **attrapée et corrigée** (`4a7c5ab`) avant clôture. Revue finale Opus 4.8 à venir. **PR `vague4 → vague3` (stacked).**
>
